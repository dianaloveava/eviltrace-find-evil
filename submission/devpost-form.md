...
Python 3.12, HTML, CSS, JavaScript, SANS SIFT-compatible export workflows, Plaso/log2timeline-style timelines, Volatility-style process exports, Sleuth Kit bodyfile imports, custom MCP-style typed tool server.
...
- Audit trail: structured logs include timestamps, tool calls, evidence refs, and no-paid-LLM token usage.
